...
def process_input(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    reasoning_results = self.reasoning.reason(processed_input,memory_context,available_tools)
    ...
    if 'processed_data' in processed_input and 'cleaned_text' in processed_input['processed_data']:
