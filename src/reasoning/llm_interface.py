...
def generate_with_system_prompt( self, system_prompt: str, user_message: str,
chat_history: List[Dict[str, str]] = None, temperature: float = 0.7, max_tokens: int = 1000 ) -> Dict[str, Any]:
    """
